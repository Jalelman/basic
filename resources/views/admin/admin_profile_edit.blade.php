       ...
       <input name="profile_image" class="form-control" type="file"  id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/admin.png') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
